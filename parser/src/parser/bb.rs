...
// use super::func_call::{func_call_args};
...
// use super::utils::{eat_sep, eat_sep2, eat_space, eat_statement, statement_end, statement_indent};
// use nom::{
//     branch::alt,
//     bytes::complete::tag,
//     combinator::{map, opt},
...
//     Err,
// };
// use crate::ast::stat_expr_types::UnOrBinOp::BinaryOp;
// use crate::Position;
//
...
//     let (input, (paren_l, names, paren_r)) = eat_sep2(tuple((
//         eat_sep2(tag("[")),
//         separated_list0(eat_sep(tag(",")), |s| varname_ws(s, state)),
//         eat_sep(tag("]")),
//     )))(input)?;
//     if names.is_empty() {
...
//     let (input, (paren_l, items, paren_r)) = eat_sep2(tuple((
//         eat_sep(tag("[")),
//         separated_list0(eat_sep(tag(",")), |s| all_exp(s, state)),
//         eat_sep(tag("]")),
//     )))(input)?;
//     Ok((
//         input,
...
//     let (input, (data_type, _, e, end_tag)) = eat_sep2(tuple((
//         |s| datatype(s, state),
//         eat_sep(tag("(")),
//         |s| all_exp(s, state),
//         eat_sep(tag(")")),
...
//     let (input, mut var_exp) = eat_sep2(alt((
//         delimited(tag("("), |s| all_exp(s, state), eat_sep(tag(")"))),
//         map(
//             |s| varname(s, state),
//             |name| Exp::VarName(RVVarName::new(name)),
...
// //         |s| varname(s, state),
// //         tag("."),
// //         separated_list0(tag("."), |s| varname(s, state)),
// //     ))(input)?;
//
// //     if names.len() == 0 {
// //         Err(Err::Error(PineError::from_pine_kind(
...
//         //         println!("----{:?}",s.0);
//         //
//         //         // let ss= BinaryOpNode::new(
//         //         //     BinaryOp.Plus,
//         //         //     StrRange::new(Position::new(0, s.0.names), Position::new(0, s.2))
//         //         // );
//         //         let mut binary_exp = BinaryExp::new(BinaryOp.Plus, s.0.names, s.2, StrRange::new_empty());
//         //         binary_exp
//         //
//         //         Assignment::new(s.0.names, binary_exp, false, None, range)
//         //     },
//         // ),
//     ))(input)
// }
