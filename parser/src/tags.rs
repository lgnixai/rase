...
tokens! {
    ...
    four_space_tag=>Token::Space(Space::FourSpace);
    one_tab_tag=>Token::Space(Space::OneTab);
    end_enter_tag=>Token::Space(Space::EndEnter);
    end_enter1_tag=>Token::Space(Space::EndEnter1);
    eof_tag => Token::EOF;
